...
# # error git submodule add git://github.com/sontek/minibufexpl.vim.git bundle/minibufexpl
# # error git submodule add git://github.com/wincent/Command-T.git bundle/command-t
...
# # error git submodule add git://github.com/sontek/rope-vim.git bundle/ropevim
